...
# - picomatch@4.0.4: Method injection logic in POSIX POSIX Character Classes
...
# - npm CLI bundled dependencies: glob@11.1.0, tar@7.5.11, minimatch@10.2.4, picomatch@4.0.4 (manually patched in npm's installation via P111 via layout-agnostic strategy)
