...
- 📊 **NEW! Metrics Dashboard** - Monitor R2 bucket usage, request counts, and storage analytics in real-time
- 🪝 **NEW! WebHooks** - Set up event notifications for bucket operations (uploads, deletes, migrations)
Slurper API
