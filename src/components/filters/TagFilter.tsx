...
export function TagFilter({
    ...
    const filteredTags = filterText.trim()
        ? availableTags.filter(t => t.tag.toLowerCase().includes(filterText.toLowerCase()))
        : availableTags
    ...
    return (
        ...
        >
            ...
            {isOpen && (
                ...
                >
                    {/* Match mode toggle */}
                    <div className="tag-filter-match-mode" role="radiogroup" aria-label="Match mode">
                        <label>
                            <input
                                type="radio"
                                name="tag-match-mode"
                    ...
                    {availableTags.length > 5 && (
                        <div className="tag-input-container" style={{ marginBottom: '0.5rem' }}>
                            <input
                                type="text"
                                className="tag-input"
                    ...
                    {/* Tag list */}
                    <div className="tag-filter-list" role="listbox" aria-multiselectable="true">
                        {filteredTags.length > 0 ? (
                            ...
                            <div className="tag-filter-item" style={{ color: 'var(--text-tertiary)', fontStyle: 'italic' }}>
