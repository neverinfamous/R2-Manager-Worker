...
export function JobHistoryDialog({ open, jobId, onClose }: JobHistoryDialogProps): JSX.Element | null {
    ...
    <div className="job-dialog-overlay" onClick={handleOverlayClick}>
      <div className="job-dialog">
        <div className="job-dialog-header">
          ...
          <div className="job-dialog-job-id">
            Job ID: {jobId}
          </div>
        </div>
        ...
        <div className="job-dialog-content">
          {loading ? (
            ...
            <div className="job-dialog-empty">
              ...
              {events.map((event) => {
                ...
                return (
                  <div key={event.id} className="job-timeline-event">
                    ...
                    <div className={`job-timeline-content ${isTerminal ? 'terminal' : ''}`}>
                      <div className="job-timeline-header">
                        <span className="job-timeline-label">
                          {getEventLabel(event.event_type)}
                        </span>
                        <span className="job-timeline-time" title={time.absolute}>
                          {time.relative}
                        </span>
                      </div>
                      {details && (
                        <div className="job-timeline-details">
                          {details}
                        </div>
                      )}
                    </div>
