...
import { BUCKET_COLORS, getColorHex, type BucketColor } from '../../utils/bucketColors'
...
export function BucketColorPicker({
    ...
    const colorLabel = value ? BUCKET_COLORS.find(c => c.value === value)?.label : undefined

    return (
        <div className="bucket-color-picker" ref={containerRef} data-open={isOpen ? "true" : undefined}>
            <button
                ref={buttonRef}
                type="button"
                onClick={(e) => {
