...
export default function BucketManager() {
  ...
  return (
    <div className="container">
        ...
        <div className="modal-overlay" onClick={() => !deleteConfirmState.isDeleting && setDeleteConfirmState(null)}>
          <div className="modal-dialog" onClick={(e) => e.stopPropagation()}>
            ...
            <p style={{ color: '#ff6b6b', fontWeight: 'bold' }}>
              ΓÜá∩╕Å This will permanently delete all files and the bucket. This cannot be undone.
            </p>
      ...
      {selectedBucket && <FileGrid bucketName={selectedBucket} onBack={() => setSelectedBucket(null)} />}
    </div>
  )
}
